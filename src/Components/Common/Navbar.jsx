    ...
    <div className="bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      >
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
          <div className="flex justify-between items-center h-24 lg:h-20 py-3">
            {/* Logo - Redesigned according to client requirements */}
            <div
              className="flex items-center cursor-pointer group text-center px-1 space-x-2"
              onClick={() => handleNavClick("home")}
            >
              {/* Logo on the left */}
              <div className="relative h-6 w-6 sm:h-8 sm:w-8 rounded-md overflow-hidden transition-all duration-300 group-hover:-translate-y-0.5">
                <img
                  src={LogoImage}
                  alt="Company Logo"
            ...
            <ul className="hidden lg:flex items-center gap-8">
              ...
              <li className="relative" ref={dropdownRef}>
                ...
                {/* Dropdown */}
                <div
                  className={`absolute top-full right-0 mt-2 bg-white rounded-xl shadow-xl overflow-hidden transition-all duration-300 w-32 ${
                    isLangDropdownOpen
          ...
          >
            <div className="py-4 space-y-4">
              ...
              <div className="px-4 pt-2" ref={mobileDropdownRef}>
                ...
                <div
                  className={`mt-2 bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 ${
                    isLangDropdownOpen
